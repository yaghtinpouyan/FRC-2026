...
public class Intake extends SubsystemBase{
    ...
    public Command raisePivot(){
        return runOnce(() -> pivotController.setSetpoint(5,ControlType.kMAXMotionPositionControl));
    }

    public Command lowerPivot(){
        return runOnce(() -> pivotController.setSetpoint(-113,ControlType.kMAXMotionPositionControl));
    }
